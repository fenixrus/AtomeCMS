...
define('ATOME_ROOT_DIR', dirname( dirname(__FILE__) ));
...
define('ATOME_THEMES_DIR', ATOME_ASSETS_DIR . DS . 'Themes');

define('ROOT_HOST', $_SERVER['SERVER_NAME']);
define('ROOT_PORT', $_SERVER['SERVER_PORT']);
define('ROOT_HTTPS', !empty($_SERVER['HTTPS']));
define('ROOT_THEMES', (ROOT_HTTPS ? 'https://' : 'http://') . ROOT_HOST . '/assets/Themes' );
